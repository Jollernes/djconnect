    ...
    <Card className="group flex flex-col overflow-hidden rounded-2xl border-amber-100/60 bg-[#fbf8f3] shadow-sm transition-shadow hover:shadow-md">
      ...
      <div className="relative w-full">
        ...
        >
          ...
          {/* +N fotos counter */}
          <span
            className="absolute bottom-3 left-3 inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[10.5px] font-semibold uppercase tracking-[0.08em] text-white shadow-sm"
      ...
      {/* Content + thumbnails side by side */}
      <div className="grid grid-cols-[1fr_auto] gap-3 px-5 pb-5 pt-4">
