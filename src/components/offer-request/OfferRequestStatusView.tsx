...
/**
 * Cohesive minimal status view for an offer request. Used both by the
 * standalone public page and by the dashboard-embedded page so the layout
 * and visual language stay identical regardless of how the customer arrived.
 */
export function OfferRequestStatusView({
  ...
  return (
    <div className={cn("space-y-8", className)}>
      {showHeading && (
        <header>
          ...
          <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
            We've contacted DJs who match your event. Quotes appear here as they arrive
            — no need to refresh.
          </p>
      ...
      {/* Brief recap — collapsed by default */}
      <BriefRecap
        record={record}
        open={briefOpen}
