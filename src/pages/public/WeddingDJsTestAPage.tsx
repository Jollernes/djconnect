...
export function WeddingDJsTestAPage() {
  useDocumentHead({
    title: "[Test A] Wedding DJs · Horizontal filters · DJConnect",
    description: "Design test variant — horizontal filter bar above a 4-column DJ grid.",
